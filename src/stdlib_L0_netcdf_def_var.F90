...
!
submodule (stdlib_netcdf) stdlib_L0_netcdf_def_var
...
contains 
   ...
   subroutine netCDF_def_var( ncId, varName, xtype, dimIds, varID )
      USE netcdf, only: nf90_def_var, f90_NoErr
      !
      ...
      integer :: ierr
      !
      ierr = nf90_def_var( ncId, varName, xtype, dimIds, varID )
      if ( ierr /= f90_NoErr ) ERROR STOP
      !
   end subroutine netCDF_def_var
   !
end submodule stdlib_L0_netcdf_def_var
